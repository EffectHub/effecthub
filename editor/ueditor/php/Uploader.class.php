...
class Uploader
{
    ...
    private function upFile( $base64 )
    {
        ...
        //Chenzhi Wu Add to support absolute path;
        $this->fullName = $this->config[ "savePath" ].$this->fileDir. '/' . $this->fileName;
    }
    ...
    {
        // Chenzhi Wu Modified to support absolute path
        $pathStr =  $_SERVER['DOCUMENT_ROOT'].$this->config[ "savePath" ];

        if ( strrchr( $pathStr , "/" ) != "/" ) {
            $pathStr .= "/";
        }
        $this->fileDir = date("Ymd");
        $pathStr .= $this->fileDir;
