...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,maxImageSideLength:670                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        , toolbars: [["source","fullscreen","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","bold","italic","fontsize","justifyleft","justifycenter","justifyright","indent","insertimage","blockquote","horizontal","insertcode","help"]]
...
//           ]
        ...
        //快捷菜单
        //,shortcutMenu:["fontsize","bold","italic","insertorderedlist","insertunorderedlist"]
