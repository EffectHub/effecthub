...
<div style="background-color:#393939;padding:3px;padding-left:10px;">
	 <span style="font-size:170%;font-weight:bold;color:white;" >Particle2dx For EffectHub </span>
	 ...
	 <a target="_blank" href="http://www.effecthub.com/item/demo/Particle2dx/">Recent Works</a>
	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
...
<div id="background" style="display:none; " >							
		...
		<table><tr>
			<td id="dropzone_bg" dropzone style="border:1px solid #666666; width:160px; height:80px;">
				...
				<?php }else{ ?>
					<a rel="leanModal" type="button" name="login" href="#login">Background</a>
				<?php } ?>
...
<?php $timestamp = time();?>
		$(function() {
			...
			<td id="dropzone_fg" dropzone style="border:1px solid #666666; width:160px; height:80px;">
				...
				<?php }else{ ?>
					<a rel="leanModal" type="button" name="login" href="#login">Foreground</a>
				<?php } ?>
			</td>
		</tr><tr>
			<td>
...
<div style="border-bottom:1px solid #444444;  width:900; nowrap;">
	...
	<strong><span class="headchar">I</span>mport</strong></a>&nbsp;
	...
	<?php }else{ ?>
		<a style="font-size:140%;" rel="leanModal" type="button" name="login" href="#login"><strong><span class="headchar">S</span>ave</strong></a>&nbsp;
	<?php } ?>
...
<div id="topleft_pane_save" style=" display:none; " >	
		...
		<form name="form_post_save" method="post" >
			Title&nbsp;&nbsp;&nbsp;<input type="text" name="png_workname" id="png_workname" value="particle_texture" 
				onKeyUp=" $('a[id^=dl_link_]').html(this.value+'.png'); return " /><br/><br/>
			Price&nbsp;&nbsp;<input type="text" id="price" name="price" placeholder="" value="10">
				...
				<br/><br/>
			    &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
			    <input type="button" id="panelink_save_btn" value="Save to Cloud"/>
			    <label id="uploadtext" style="display:none">Uploading to Cloud...</label>
		</form>
	...
	<table><tr><td id='textures'>
		...
		<div id="dropzone" dropzone style="border:1px solid #666666; width:160px; height:80px;">
			<?php if($_REQUEST['uid']!=0){?>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="mytexture_btn"  rel="leanModal" type="button" name="texture" href="#texture">My Texture</a>
				<a target="_blank" href="http://www.effecthub.com/item/featured/MostRecent/Texture">More...</a>
			<?php }else{ ?>
				<a rel="leanModal" type="button" name="login" href="#login">Upload Texture</a>
			<?php } ?>
			</div>
		<script type="text/javascript">
		var response;
	...
	<script>
	   ...
	   $("td[col=col]").bind("mouseout",function(){ 
	   	  ...
	   	  $("#start_color").css("background-color",palette_col);
			  ...
			  <br/>
			  Template:
<a id="blend_1" href="javascript:emitter[slot].setBlendFunc(gl.SRC_ALPHA, gl.ONE); dumpToInputTag(slot);">Diffuse</a>	
<a id="blend_2" href="javascript:emitter[slot].setBlendFunc(gl.ONE, gl.ONE); dumpToInputTag(slot);">Linear Dodge</a>	
<a id="blend_3" href="javascript:emitter[slot].setBlendFunc(gl.ONE_MINUS_DST_COLOR, gl.ONE); dumpToInputTag(slot);">Screen</a>	
<a id="blend_4" href="javascript:emitter[slot].setBlendFunc(gl.DST_COLOR, gl.ONE_MINUS_SRC_ALPHA); dumpToInputTag(slot);">Mutiply</a>	
<a id="blend_5" href="javascript:emitter[slot].setBlendFunc(gl.ONE, gl.ZERO); dumpToInputTag(slot);">Dissolve</a>	
<a id="blend_6" href="javascript:emitter[slot].setBlendFunc(gl.ONE, gl.ONE_MINUS_SRC_ALPHA); dumpToInputTag(slot);">Premnitiply</a>
<a id="blend_7" href="javascript:emitter[slot].setBlendFunc(gl.DST_COLOR, gl.SRC_COLOR); dumpToInputTag(slot);">Lighten</a>
				<br/>
			  Custom:<br/>
...
<ul class="tabs">
	<li style="margin:20px 0 0 10px"><a href="#login-ct" style="color:#000"> Login </a></li>
	<li style="margin:20px 0 0 20px"><a href="#register-ct" class="selected" style="color:#000"> Register </a></li>
</ul>
</div>
...
<span id="emailError" class="formErrorContent drop-shadow"></span>
				  ...
				  <div class="btn-fld" style="padding-left:20px;padding-right:20px;width:350px;vertical-align:center">
				    ...
				    <input type="checkbox" checked name="consent" id="consent"/></label>
					    <input class="save-btn" name="commit" type="submit" value="Sign Up for Free" onclick="_gaq.push(['_trackEvent', 'signup', 'clicked', 'Click Sign Up Button In particle2dx'])">
					</div>
					<input type="hidden" name="redirectURL" value="http://www.effecthub.com/particle2dx"/>
