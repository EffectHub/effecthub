...
<ul class="tabs">
	<li class="<?php echo $feature=='assets'?'active':'' ?>">
		<a href="<?=site_url('folder/'.$folder['id'])?>"><?= $this->lang->line('folder_header'); ?>: <?php echo $folder['folder_name']; ?></a>
	</li>
	<?php if ($this->session->userdata('id')&&$this->session->userdata('id')!=$user['id']){  ?>
	<?php if ($watch==null){  ?>
		<a class="form-sub tagline-action" style="float:right" href="javascript:" id='watchFolder' name="<?php echo $folder['id']; ?>"><?= $this->lang->line('file_watch'); ?></a>
		<input type="hidden" id="watch" value="0" />
	<?php  }else{?>
		<a class="form-sub tagline-action" style="float:right" href="javascript:" id='watchFolder' name="<?php echo $folder['id']; ?>"><?= $this->lang->line('file_unwatch'); ?></a>
		<input type="hidden" id="watch" value="1" />
	<?php  }?>
	<?php  }else{?>
		<a class="form-sub tagline-action" style="float:right"  rel="leanModal" name="login" href="#login"><?= $this->lang->line('file_watch'); ?></a>
	<?php  }?>
</ul>
...
<dd class="ellipsis hotrec-dd" title="<?php echo $_folder['folder_name']; ?>"><a href="<?=site_url('folder/'.$_folder['id'])?>" class="hotrec-link"><span class="hotrec-txt"><?php echo $_folder['folder_name']; ?></span></a></dd>
<?php endforeach; ?>
...
<?php if (isset($folder)){  ?>
	...
	<span class="last" style="color:#000;max-width:300"><?=$folder['folder_name'] ?></span>
<?php }  ?>	
<span id="dirLocation"> </span>
</li>
<li id="dirData">
<span><span class="loadedDate" style="color:#000">
<?=$folder['watch_num'] ?> <?= $this->lang->line('folder_audience'); ?> <?=$folder['view_num'] ?> <?= $this->lang->line('folder_view'); ?> <?=isset($folder_count)?$folder_count:'' ?> <?= $this->lang->line('folder_folders'); ?> <?=$item_count ?> <?= $this->lang->line('folder_files'); ?> <?php echo isset($folder_size)?getRealSize($folder_size):'' ?></span></span>
</li>
...
<p>
<span class="b-fl input-cbx selectionArbitrate"><dfn><s class="sprite"></s></dfn></span>
...
<a class="bbtn" hidefocus="true" href="javascript:;"  onclick="_gaq.push(['_trackEvent', 'downloadBtn', 'clicked', 'Click Download Button In Folder'])" id="barCmdDownload" _i="8"><em class="icon-download"></em><b><?= $this->lang->line('file_download'); ?></b></a>
		...
		$(function() {
			$('#file_upload').uploadify({
			    ...
			    'onQueueComplete' : function(queueData) {
		            ...
		            else window.location.href = '<?=site_url('folder/')?>/'+currentFolder;
		        }
			});
		});
	</script>  
	...
	<div class="txt-fld" style="padding:0px 20px 35px 20px">
				...
				<form action="<?=site_url('login/check')?>" method="post">
				  ...
				  <div class="btn-fld" style="padding-left:20px;padding-right:20px;width:350px;vertical-align:center">
					...
					<input type="hidden" name="redirectURL" value="<?=site_url('folder/'.$folder['id'])?>"/>
...
-->
<div id="contentId" style="height:196px;overflow:auto"><ul class="treeview treeview-content treeview-ancestor"><li><div class="treeview-node treeview-root _minus" _pl="0px" style="padding-left: 0px;"><span class="treeview-node-handler"><em class="b-in-blk plus sprite-ic2 minus"></em><dfn class="b-in-blk treeview-ic"></dfn><span class="treeview-txt"><?php echo $type_name; ?></span></span></div>
<ul class="treeview treeview-content">

<?php foreach($user_folder_list as $key=>$_folder): ?>
<li><div class="treeview-node" _pl="15px" style="padding-left: 15px;"><span class="treeview-node-handler"><em class="b-in-blk plus sprite-ic2"></em><dfn class="b-in-blk treeview-ic"></dfn><span class="treeview-txt"><?php echo $_folder['folder_name']; ?></span></span></div><ul class="treeview treeview-content treeview-collapse"></ul></li>
<?php endforeach; ?>
</ul></div>
