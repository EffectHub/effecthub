...
<ul class="tabs">
	<li class="selected"><a href="#" class="selected"><?= $this->lang->line('itemupload_title'); ?> to <?= $tool['name'] ?></a></li>
	<a class="form-sub tagline-action" style="float:right;" href="<?php echo site_url('item/demo/'.$tool['domain'])?>"><?= $this->lang->line('item_return'); ?></a>
</ul>
...
<div class="form-field">
			...
			<input type="hidden" id="platform" name="platform" value="<?= $tool['platform'] ?>"/>
			<input type="hidden" id="type" name="type" value="<?= $tool['type'] ?>"/>
