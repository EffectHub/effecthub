...
<ul class="tabs">
	<li class="active">
		<a href="<?=site_url('folder/'.$folder['id'])?>"><?php echo $type_name; ?> <?= $this->lang->line('folder_header'); ?>: <?php echo $folder['folder_name']; ?></a>
	</li>
	( <?=$folder['watch_num'] ?> <?= $this->lang->line('folder_audience'); ?> <?=$folder['view_num'] ?> <?= $this->lang->line('folder_view'); ?> <?=isset($folder_count)?$folder_count:'' ?> <?= $this->lang->line('folder_folders'); ?> <?=$item_count ?> <?= $this->lang->line('folder_files'); ?> <?php echo isset($folder_size)?getRealSize($folder_size):'' ?> )
	...
	<?php  }?>
	<a class="form-sub tagline-action" style="float:right" target="_blank" href="<?=site_url('folder/download/'.$folder['id'])?>"><?= $this->lang->line('file_download'); ?></a>
	<?php  }else{?>
		<a class="form-sub tagline-action" style="float:right"  rel="leanModal" name="login" href="#login"><?= $this->lang->line('file_watch'); ?></a>
		<a class="form-sub tagline-action" style="float:right"  rel="leanModal" name="login" href="#login"><?= $this->lang->line('file_download'); ?></a>
	<?php  }?>
</ul>
	    ...
	    <div class="effecthub">
	      <div class="effecthub-shot">
	        <div class="effecthub-img">
	          <a href="<?=site_url('item/'.$_item['id']).'?folder='.$folder['id']?>" class="effecthub-link"><div data-picture="" data-alt="<?php echo $_item['title']; ?>">
  ...
  <?php  }?>	
	          ...
	          <a href="<?=site_url('item/'.$_item['id']).'?folder='.$folder['id']?>" class="effecthub-over" style="opacity: 0;">		<strong><?php echo $type_name; ?> - <?php echo $_item['title']; ?></strong>
	        ...
	        <ul class="tools group" style="visibility: visible;">
	          <li class="fav">
	            <a href="<?=site_url('item/'.$_item['id']).'?folder='.$folder['id']?>" title="See fans of this work"><?php echo $_item['fav_num']; ?></a>
	            </li>
	          <li class="cmnt">
	            <a href="<?=site_url('item/'.$_item['id']).'?folder='.$folder['id']?>#comments" title="View comments on this work"><?php echo $_item['comment_num']; ?></a>
	            </li>
