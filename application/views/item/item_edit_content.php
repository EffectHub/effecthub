...
<div id="main" style="width:100%">
		        ...
		        <script type="text/javascript">
		            ...
		            var flashvars = {"token":"<?php echo $user['token']?>","uid":"<?php echo $user['id']?>","id":"<?php echo $item['id']?>"};
		            var params = {};
		            params.quality = "high";
            ...
            <script type="text/javascript"> 
		        ...
		        <form action="<?=site_url('item/editcode/'.$item_code['id'])?>" id="signin_form" method="post">	
  ...
  <?php  }else{?>
    ...
    <div id="file" class="pop">
			<div id="file-ct">
				...
				<div class="txt-fld">
				<label for=""><?= $this->lang->line('itemeditcontent_uploaded'); ?></label>
		...
		<div id="signup" class="pop">
			<div id="signup-ct">
				<div id="signup-header" class="pop-header">
					<h2><?= $this->lang->line('itemeditcontent_edit_code'); ?></h2>
				  ...
				  <div class="txt-fld">
				    ...
				    <input id="" name="title" type="text" value="<?php echo $item['title']?>"/>

				  </div>
				  <div class="txt-fld">
				    <label for=""><?= $this->lang->line('itemeditcontent_description'); ?></label>
				    <textarea name="desc" id="desc" style="height: 100px; "  placeholder=""/><?php echo $item['desc']?></textarea>
				  </div>
				  <div class="txt-fld">
    ...
    <input class="save-btn" name="commit" type="submit" value="<?= $this->lang->line('itemeditcontent_save'); ?> &raquo;">
</div>
			</div>
		</div>
    </div>
