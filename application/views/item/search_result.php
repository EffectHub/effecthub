...
<div class="full full-pitch group">
	<h1 class="compact">
		...
		<a rel="tipsy" original-title=<?= $this->lang->line('itemsearch_sign_up_weibo'); ?> class="auth-weibo tagline-action" href="<?=site_url('login/sina')?>"></a>
	</h1>
</div>
<?php  }?>
<div class="secondary">
...
<a href="#options" id="options-toggle" class="">
	...
	<div class="what-is-pro-search">
		<h3><?= $this->lang->line('itemsearch_search_authors'); ?></h3>
	...
	<h3><?= $this->lang->line('itemsearch_searching_pop'); ?></h3>
...
<div id="main" class="main-search">
	...
	<h2><?= $this->lang->line('itemsearch_searching_result'); ?>"<?php echo $input_str;?>"</h2>
<ol class="group-cards">
	<?php foreach($results as $_result): ?>
                   <div class='commentitem' style='border-bottom: 1px solid #CDCDCD;padding-bottom:15px;padding-top:15px;'>
                            ...
                            <div>
                                <div class='paragraphstyle'><b><a href="<?=site_url('item/'.$_result['id'])?>"><?php echo $_result['title']; ?></b></a> </div>
                                <div class="commenttext" style='margin-top:21px;margin-left:90px'><?php echo $_result['desc']; ?></div>
                            </div>
                   </div>    
                 <?php endforeach; ?> 
