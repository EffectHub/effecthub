...
<ul class="tabs">
	<li class="active">
		<a href="<?=site_url('t/'.$tool['domain'])?>"><?php echo $tool['name']; ?> <?= $this->lang->line('item_tool_showcase_title'); ?></a>
	</li>
	<?php if ($this->session->userdata('id')){  ?>
	<a class="form-sub tagline-action" style="float:right" href="<?php echo site_url('item/submitshowcase/'.$tool['id'])?>"><?= $this->lang->line('item_tool_showcase_submit'); ?></a>
	<?php  }else{?>
	<a class="form-sub tagline-action" style="float:right"  rel="leanModal" type="button" name="login" href="#login"><?= $this->lang->line('item_tool_showcase_submit'); ?></a>
	<?php  }?>
	<a class="form-sub tagline-action" style="float:right" href="<?=site_url('t/'.$tool['domain'])?>">← <?= $this->lang->line('item_tool_demo_back'); ?> <?php echo $tool['name']; ?></a>
</ul>
<ul class="tabs">
			<?php if ($nav=='explore'){  ?>
	<li class="<?php echo $feature=='MostAppreciated'?'active':'' ?>">
		<a href="<?=site_url('item/showcase/'.$tool['domain'].'/MostAppreciated')?>"><?= $this->lang->line('header_explore_top');?></a>
	</li>
	<li class="<?php echo $feature=='MostDiscussed'?'active':'' ?>">
		<a href="<?=site_url('item/showcase/'.$tool['domain'].'/MostDiscussed')?>"><?= $this->lang->line('header_explore_popular');?></a>
	</li>
	<li class="<?php echo $feature=='MostRecent'?'active':'' ?>">
		<a href="<?=site_url('item/showcase/'.$tool['domain'].'/MostRecent')?>"><?= $this->lang->line('header_explore_recent');?></a>
	</li>
	<?php  }?>
</ul>
