...
<ul class="tabs">
	<li class="active">
		<a href="#">Works Created for <?php echo $platform['name']; ?> Platform</a>
	</li>
	<a class="form-sub tagline-action" style="float:right" href="<?=site_url('item/featured/MostAppreciated')?>">← Back</a>
</ul>
<ul class="tabs">
			<?php if ($nav=='explore'){  ?>
	<li class="<?php echo $feature=='MostAppreciated'?'active':'' ?>">
		<a href="<?=site_url('item/platform/'.$platform['key'].'/MostAppreciated')?>">Top</a>
	</li>
	<li class="<?php echo $feature=='MostDiscussed'?'active':'' ?>">
		<a href="<?=site_url('item/platform/'.$platform['key'].'/MostDiscussed')?>">Popular</a>
	</li>
	<li class="<?php echo $feature=='MostRecent'?'active':'' ?>">
		<a href="<?=site_url('item/platform/'.$platform['key'].'/MostRecent')?>">Recent</a>
	</li>
	<?php  }?>
</ul>
