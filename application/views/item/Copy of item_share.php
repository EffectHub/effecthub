...
<ul class="tabs">
	<li class="selected"><a href="#" class="selected">Share other's works from internet</a></li>
</ul>
...
<div class="form-field">
            ...
            <fieldset>
                <label for="url">ScreenShot (Required)</label>
		            ...
		            <div class="form-field">
		<fieldset>
                <label for="title">Preview URL (Required)</label> 
		            <input type="text" class="signin_input txt" id="preview" name="preview" placeholder="" value="">
		            <span id="previewError" class="formErrorContent drop-shadow">This field is required</span>
		            </fieldset>
...
<span title="Weibo<?php echo $this->session->userdata('token_sina')==null?'(Not Connected)':'' ?>" class="ico_sina"></span>
			...
			<input type="hidden" name="share" value="1"/>
				<input class="form-sub" name="commit" type="button" value="Share" onclick="checkshare()">
			</div>
</form>	</div>
