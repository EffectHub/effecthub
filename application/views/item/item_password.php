...
<div class="full">
	<h1 class="alt"><?= $this->lang->line('itemprivate_passwordtitle'); ?></h1>
</div>

<div id="main" class="site">
<div class="col-about col-about-full under-hero">
<h2 class="section"><?= $this->lang->line('itemprivate_inputpassword'); ?></h2>

<p><?= $this->lang->line('forgot_content1'); ?></p>
    
    <form id="signin_form" style="height:270px;font-size:14px" class="gen-form" method="post" action="<?=site_url('item/'.$item_id)?>" method="post">
