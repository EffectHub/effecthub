...
$(document).ready(function(){
	$.ajax({  
             type:"GET" 
             ,url:"<?=base_url()?>index.php/admin/stats/task_chart/1"  
             ,data:{id:1}                                
             ...
             ,success:function(data){  
			  ...
			  var plot2 = $.jqplot('chart2', [arr], {
			    ...
			    title:'Task Growth Trend Tracking By Month',
			    axes:{
			      xaxis:{
...
<div id="main" class="site">
	...
	<table class="dataintable browsersupport">
	  <tbody><tr>
	      ...
	      <th>Answer Count</th>
	      <th>View Count</th>
	      <th>Task Assets Count</th>
	      <th>Answer Assets Count</th>
	      <th>User Count</th>
	  </tr>
	  <tr>
	      <td><?php echo $task_count['count'] ?></td>		
	      <td><?php echo $task_count['response_count'] ?></td>	
	      <td><?php echo $task_count['view_count'] ?></td>	
	      <td><?php echo $task_assets_count['count'] ?></td>	
	      <td><?php echo $bid_assets_count['count'] ?></td>	
	      <td><?php echo $task_count['user_count'] ?></td>	
	  </tr>
	</tbody></table>
	</p>
	</div>
