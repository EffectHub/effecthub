...
$(document).ready(function(){
	$.ajax({  
             type:"GET" 
             ,url:"<?=base_url()?>index.php/admin/stats/team_chart/1"  
             ,data:{id:1}                                
             ...
             ,success:function(data){  
			  ...
			  var plot2 = $.jqplot('chart2', [arr], {
			    ...
			    title:'Team Growth Trend Tracking By Month',
			    axes:{
			      xaxis:{
...
<div id="main" class="site">
	...
	<table class="dataintable browsersupport">
	  ...
	  <tr>
	      <td><?php echo $team_count['count'] ?></td>	
	      <td><?php echo $team_count['view_count'] ?></td>	
	      <td><?php echo $team_count['member_count'] ?></td>	
	      <td><?php echo $team_count['project_count'] ?></td>		
	      <td><?php echo $team_count['work_count'] ?></td>	
	      <td><?php echo $team_comment_count['count'] ?></td>	
	      <td><?php echo $team_count['user_count'] ?></td>	
	  </tr>
	</tbody></table>
	</p>
	</div>
