...
$(document).ready(function(){
	$.ajax({  
             type:"GET" 
             ,url:"<?=base_url()?>index.php/admin/stats/topic_chart/1"  
             ,data:{id:1}                                
             ...
             ,success:function(data){  
			  ...
			  var plot2 = $.jqplot('chart2', [arr], {
			    ...
			    title:'Topic Growth Trend Tracking By Month',
			    axes:{
			      xaxis:{
...
<div id="main" class="site">
	...
	<table class="dataintable browsersupport">
	  ...
	  <tr>
	      <td><?php echo $group_count['count'] ?></td>		
	      <td><?php echo $topic_count['count'] ?></td>	
	      <td><?php echo $topic_comment_count['count'] ?></td>	
	      <td><?php echo $topic_count['view_count'] ?></td>	
	      <td><?php echo $group_count['member_count'] ?></td>	
	  </tr>
	</tbody></table>
	</p>
	</div>
