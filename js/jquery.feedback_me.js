	...
	function appendFeedbackToBody(fm_options) {
		...
		if (fm_options.show_form === true) {
			form_html = '<form class="feedback_me_form">'
				...
				+		'<li>	<label for="feedback_message">' + fm_options.message_label + '</label> ' + message_asterisk + ' <textarea rows="6" class="feedback_message" ' + message_required + ' placeholder="' + fm_options.message_placeholder + '"></textarea> </li>'
